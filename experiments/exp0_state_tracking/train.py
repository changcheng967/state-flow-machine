...
class Trainer:
    ...
    def train_epoch(self) -> Dict[str, float]:
        ...
        for batch_idx, batch in enumerate(self.train_loader):
            ...
            # Compute MSE loss in FP32 outside autocast to avoid dtype mismatch
...
def run_experiment(
    ...
    transformer_fair_trainer = Trainer(
        ...
        is_transformer=True,
        grad_accum_steps=grad_accum_steps,  # Same as execution for fair comparison
        use_amp=use_amp,  # AMP enabled for transformers (loss computed in FP32)
        rank=rank,
