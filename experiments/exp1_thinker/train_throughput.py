...
os.environ.setdefault("GLOG_v", "3")  # ERROR only (suppress DEBUG/INFO/WARNING)
...
# NOTE: GRAPH_OP_RUN=1 (needed for memory_offload) is INCOMPATIBLE with
# OpenI's msrun launcher — requires OpenMPI. Offload is not viable here.
try:
